...
`<div>
  <h1>👋🏻 Hi! I'm Ryan.</h1>
  <h2>I (help) build things on the internet! 🌈</h2>
  <p>Right now I'm working on a new company, called <a href="https://begin.com">Begin</a>.</p>
  <p>It's a tool to help people build the software of the future: serverlessly.</p>
  <p>I'm super biased, but it's pretty neat.</p>
</div>
<div>
  <h2>Anyway</h2>
